 ...
 */
public class OffersMenu extends com.avaya.sce.runtime.Invoke {
	...
	public java.util.Collection getInputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("input_propertyFileName", "Offer:Menu", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
