 ...
 */
public class ActInfo extends com.avaya.sce.runtime.Subflow {
	...
	protected java.util.Map<String,String> getExitPoints() {
		...
		exitPoints.put("AccountInfo-exit", "Menu2-exit");
		exitPoints.put("AccountInfo-CallTransfer", "Menu2-CallTransfer");
		return exitPoints;
	}
}
